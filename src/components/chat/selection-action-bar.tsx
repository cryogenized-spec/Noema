...
interface SelectionActionBarProps {
  ...
  onDraftTask: () => Promise<void>;
  onDraftDocument: () => Promise<void>;
  onDraftEvent: () => Promise<void>;
}
    ...
    <div className="rounded-2xl border border-emerald-300/30 bg-emerald-500/10 px-3 py-2">
      ...
      <div className="mt-2 grid grid-cols-2 gap-2">
        ...
        <button
          type="button"
          disabled={selectedCount === 0}
          className="rounded-xl border border-violet-300/25 bg-violet-500/10 px-3 py-2 text-left text-sm text-violet-100 disabled:opacity-50"
          onClick={() => void onDraftTask()}
        >
          Draft task
        </button>
        <button
        ...
        <button
          type="button"
          disabled={selectedCount === 0}
          className="col-span-2 rounded-xl border border-violet-300/25 bg-violet-500/10 px-3 py-2 text-left text-sm text-violet-100 disabled:opacity-50"
          onClick={() => void onDraftEvent()}
        >
          Draft event
        </button>
      </div>
